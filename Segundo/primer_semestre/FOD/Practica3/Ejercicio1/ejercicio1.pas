...
procedure baja(var arc_logico:arch);
var e:empleado; pos,num:integer;
begin
	...
	// busco el empleado
	read(arc_logico,e);
	while(not eof(arc_logico)) and (num <> e.numEmpleado) do
		read(arc_logico,e);

	//si se encontró el empleado, se elimina
	if(num = e.numEmpleado) then
	begin
